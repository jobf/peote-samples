...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PeoteViewInsideOpenFL", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("PeoteViewInsideOpenFL", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "semmi";
		app.meta["file"] = "PeoteViewInsideOpenFL";
		app.meta["name"] = "PeoteViewInsideOpenFL";
		app.meta["packageName"] = "peote.view";
